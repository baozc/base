...
.pay_online {
 ...
 <form action="/member/buy/buySubmit" id="checkoutFrom"  onsubmit="return validateForm()" method="post">
   ...
   <div class="pay-list">
    <ul>
     ...
     <c:forEach items="${results}" var="item">
      ...
      <li class="ui-clr"><span class="name"><input type="hidden" name="ids" value="${item.id}"><a href="/product/detail/${item.scoreProduct.id}.htm">${item.scoreProduct.name}</a></span>
   <span class="num"><em class="color">${item.buyNum}</em>份</span></li>
     </c:forEach>
    </ul>
   </div>
      ...
      <div data-pro="paySelector">
       <div class="w-pay" id="pro-view-2">
        ...
        <div class="w-pay-selector">
          ...
          <label class="w-pay-type w-pay-type-3  pwxpay"><input type="radio" name="payType" value="5" style="display: none;" ><img src="${wapBase}/style/images/wx.png" height="30px;"></label>
         ...
         <div style="float: left;display: none;" id="weixinPay">
          <label class="w-pay-type w-pay-type-3  wxpay"><input type="radio" name="payType" value="2" style="display: none;"><img src="${wapBase}/style/images/wx.png" height="30px;"></label>
          <%--        <a href="${qrcodeUrl }">${qrcodeUrl }</a> --%>
         </div>
         <div style="float: left;display: none;" id="qapply">
          <label class="w-pay-type w-pay-type-3  qapply"><input type="radio" name="payType" value="7" style="display: none;">青苹果</label>
         </div>
        </div>
       </div>
      </div>
