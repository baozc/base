...
public class ListDto {
	    ...
	    private String buy_gift_integral;
	    ...
	    private String thumb200_0;

	    private String thumb200w_0;
	    ...
	    public void setGoods_subtit(String goods_subtit){
	        this.goods_subtit = goods_subtit;
	    }
	    public String getGoods_subtit(){
	        return this.goods_subtit;
	    }
	    ...
	    public void setNeed_num(long need_num){
	    ...
	    public void setMax_qishu(String max_qishu){
	        this.max_qishu = max_qishu;
	    }
	    public String getMax_qishu(){
	    ...
	    public void setLast_dbtime(String last_dbtime){
	        this.last_dbtime = last_dbtime;
	    }
	    public String getLast_dbtime(){
	        return this.last_dbtime;
	    }
	    ...
	    public void setGobuy(String gobuy){
	        this.gobuy = gobuy;
	    }
	    ...
	    public void setBuy_gift_integral(String buy_gift_integral){
	        this.buy_gift_integral = buy_gift_integral;
	    }
	    public String getBuy_gift_integral(){
	        return this.buy_gift_integral;
	    }
	    ...
	    public void setImgurl_src(String imgurl_src){
	        this.imgurl_src = imgurl_src;
	    }
	    public String getImgurl_src(){
	        return this.imgurl_src;
	    }
	    ...
	    public void setHas_time(Long has_time){
	    ...
	    public void setThumb200_0(String thumb200_0){
	        this.thumb200_0 = thumb200_0;
	    }
	    public String getThumb200_0(){
	        return this.thumb200_0;
	    }
	    public void setThumb200w_0(String thumb200w_0){
	        this.thumb200w_0 = thumb200w_0;
	    }
	    public String getThumb200w_0(){
	        return this.thumb200w_0;
	    }
