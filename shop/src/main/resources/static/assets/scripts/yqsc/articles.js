...
var ArticleObject = {
	...
	_reg_search_btn_event : function() {
		$("#pf-btn-search").click(function() {
			$("#pf-table-article").bootstrapTable("refresh", {
				url : "/yqsc/articles/all.json?type=" + type + "&cateId=" + $("#articleCateId").val() + "&searchText=" + encodeURIComponent($("#searchbox").val()),
				pageNumber : 1
			});
		});
	},
	...
	_init_app_table : function() {
		$("#pf-table-article").bootstrapTable(
				{
					method : 'get',
					url : "/yqsc/articles/all.json?type=" + type,
					cache : false,
					// height : 400,
					...
					columns : [
							...
							},
							{
								...
								formatter : function(value, row, index) {
									...
									return html
											+ '<a href="/yqsc/articles/edit?id=' + row.id
