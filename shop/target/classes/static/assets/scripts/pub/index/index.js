    ...
    $.post('/cart/loadCart.json',{},function(data){
    	...
    	if(data.isSuccess==false || data.message.length==0){
    		...
    		for(var i=0;i<data.message.length;i++){
	    		...
	    		msg+=' <br><span class="color01">'+o.product.singlePrice+'趣购币 × '+o.buyNum+'人次</span>';
    		...
    		msg+='<div class="gwc-gmbox"><p>共有'+data.message.length+'件商品，金额总计：<strong class="color01">'+total+'趣购币</strong></p><a href="/cart" class="gwc-btn2">查看清单并结算</a></div>';
