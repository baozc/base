package cn.baozcc.me.rongcloud;
...
import cn.baozcc.me.rongcloud.models.ChatroomInfo;
import cn.baozcc.me.rongcloud.models.FormatType;
import cn.baozcc.me.rongcloud.models.GroupInfo;
import cn.baozcc.me.rongcloud.models.Message;
import cn.baozcc.me.rongcloud.models.SdkHttpResult;
import cn.baozcc.me.rongcloud.util.HttpUtil;
import cn.baozcc.util.http.HttpUrlCon;
...
public class ApiHttpClient {
	...
	//http://172.16.154.9:8098
	private static final String RONGCLOUDURI = "";//Constants.rong_url;//https://api.cn.rong.io:6550
	...
	public static SdkHttpResult getToken(String userId, String userName, String portraitUri) throws Exception {
        ...
        return new HttpUrlCon.Builder(RongCloud.url + "/user/getToken." + FormatType.json)
                .action(HttpUrlCon.POST)
                .rongCloudHeader()
                .param("userId", userId)
                .param("name", userName)
	...
	public static SdkHttpResult publishMessage(String appKey, String appSecret,
                                               String fromUserId, String toUserId, Message msg,
                                               FormatType format) throws Exception {
